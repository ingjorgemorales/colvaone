...
>
    <style>
        ...
        .ai-chat-toggle {
            ...
            box-shadow: 0 14px 34px rgba(18,63,110,0.16), 0 0 0 0 rgba(14,165,233,.18);
        ...
        .ai-chat-toggle::before {
            ...
            inset: -3px;
            border-radius: 19px;
            background: conic-gradient(from 0deg, rgba(18,63,110,0), rgba(14,165,233,.62), rgba(5,150,105,.45), rgba(18,63,110,0));
            opacity: .42;
            z-index: -1;
        ...
        .ai-chat-toggle:hover {
            ...
            box-shadow: 0 20px 44px rgba(18,63,110,0.24), 0 0 22px rgba(14,165,233,.20);
        }
        .ai-chat-toggle img {
        ...
        .ai-chat-panel {
            ...
            width: min(410px, calc(100vw - 28px)); height: min(620px, calc(100vh - 112px));
            border-radius: 20px;
            background: rgba(255,255,255,.985);
            border: 1px solid rgba(14,165,233,.18);
            box-shadow: 0 24px 66px rgba(18,63,110,.20), inset 0 1px 0 rgba(255,255,255,.96);
        ...
        .ai-chat-panel::before {
            ...
            inset: 0 0 auto 0;
            height: 3px;
            background: linear-gradient(90deg, #123f6e, #0ea5e9, #059669);
            opacity: .9;
            z-index: 1;
        }
        .ai-chat-header {
            padding: 14px 16px; display: flex; align-items: center; gap: 10px;
            border-bottom: 1px solid rgba(18,63,110,.08);
            background: linear-gradient(135deg, rgba(255,255,255,.98), rgba(240,249,255,.94));
        }
        .ai-chat-header-logo {
            ...
            box-shadow: 0 8px 18px rgba(18,63,110,.08), inset 0 0 0 1px rgba(255,255,255,.88);
        }
        ...
        .ai-chat-body {
            ...
            background:
                linear-gradient(rgba(18,63,110,.018) 1px, transparent 1px),
                linear-gradient(90deg, rgba(18,63,110,.014) 1px, transparent 1px),
                linear-gradient(180deg, rgba(248,251,255,.96), rgba(255,255,255,.98));
            background-size: 44px 44px, 44px 44px, auto;
        }
        .ai-chat-message-wrap { max-width: 86%; display: flex; flex-direction: column; gap: 4px; animation: ai-chat-message-in .22s ease both; }
        ...
        .ai-chat-message.user { background: linear-gradient(135deg,#123f6e,#1d5f99); color: white; border-bottom-right-radius: 5px; flex-direction: row-reverse; box-shadow: 0 10px 22px rgba(18,63,110,.18); }
        .ai-chat-message.assistant { background: rgba(248,251,255,.98); color: #1e293b; border: 1px solid rgba(18,63,110,.06); border-bottom-left-radius: 5px; box-shadow: 0 8px 20px rgba(18,63,110,.07); }
        ...
        @keyframes ai-chat-aura { 0%, 100% { box-shadow: 0 14px 34px rgba(18,63,110,0.16), 0 0 0 0 rgba(14,165,233,.16); } 50% { box-shadow: 0 17px 40px rgba(18,63,110,0.22), 0 0 0 7px rgba(14,165,233,0); } }
        ...
        @keyframes ai-chat-message-in { from { opacity: 0; transform: translateY(8px) scale(.985); } to { opacity: 1; transform: translateY(0) scale(1); } }
