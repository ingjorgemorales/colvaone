<x-layouts.app title="Acceso denegado" heading="Acceso denegado" subheading="Permiso insuficiente">
    <section class="mx-auto max-w-2xl rounded-lg border border-zinc-200 bg-white p-6 text-center shadow-sm">
        ...
        <h2 class="mt-5 text-2xl font-semibold">No puedes ingresar a esta seccion</h2>
        <p class="mt-3 text-sm leading-6 text-zinc-600">
            La validacion de permisos se realiza en backend. Ocultar un boton no concede acceso.
        </p>
