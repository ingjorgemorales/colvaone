...
<p style="margin:0 0 12px">Recibimos una solicitud para restablecer la contrasena de tu cuenta en <strong>CRM Administrativo</strong>.</p>
<p style="margin:0 0 12px">Ingresa este codigo en la pantalla de verificacion:</p>
