        ...
        <div class="card" style="padding:28px">
            <form method="POST" action="{{ route('applications.store') }}" style="display:flex;flex-direction:column;gap:18px">
                ...
                <div>
                    ...
                    <textarea name="description" rows="4" maxlength="1000" class="input-field @error('description') {{ 'error-field' }} @enderror" style="resize:vertical" placeholder="Para que sirve el aplicativo y quien lo usa...">{{ old('description') }}</textarea>
