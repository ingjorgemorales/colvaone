<x-layouts.app title="Tareas | {{ config('app.name') }}" heading="Tareas" subheading="Gestion y asignacion de tareas por grupo de trabajo">
    <style>
        ...
        .task-title-cell { min-width: 260px; }
        .task-title-link { display: block; line-height: 1.35; }
        .group-cell { min-width: 104px; }
        .assignees-cell { min-width: 128px; }
        .date-cell { min-width: 112px; white-space: nowrap; }
    ...
    <div class="tasks-toolbar" style="margin-bottom:20px">
        <form method="GET" class="tasks-filters">
            ...
            <select class="tasks-filter-field" name="status" style="padding:9px 14px;border-radius:10px;border:1px solid rgba(18,63,110,0.12);background:white;font-size:13px;color:#475569;outline:none;cursor:pointer">
            ...
            <select class="tasks-filter-field" name="priority" style="padding:9px 14px;border-radius:10px;border:1px solid rgba(18,63,110,0.12);background:white;font-size:13px;color:#475569;outline:none;cursor:pointer">
        ...
        <a href="{{ route('tasks.create') }}" class="btn-primary tasks-new-button">
    ...
    <div class="tasks-table-wrap" style="overflow-x:auto">
        <table class="tasks-table" style="width:100%;border-collapse:separate;border-spacing:0;font-size:13px">
            <thead>
                <tr>
            ...
            <tbody>
                @forelse($tasks as $task)
                    <tr style="transition:background 0.15s" onmouseover="this.style.background='rgba(18,63,110,0.02)'" onmouseout="this.style.background='transparent'">
                        <td class="task-title-cell" style="padding:14px 16px;border-bottom:1px solid rgba(18,63,110,0.04)">
                            <div style="display:flex;align-items:center;gap:10px">
                                ...
                                <a href="{{ route('tasks.show', $task) }}" class="task-title-link" style="font-weight:600;color:#1e293b;text-decoration:none">{{ $task->title }}</a>
                            </div>
                        </td>
                        <td class="group-cell" style="padding:14px 16px;border-bottom:1px solid rgba(18,63,110,0.04)">
                        ...
                        <td class="assignees-cell" style="padding:14px 16px;border-bottom:1px solid rgba(18,63,110,0.04)">
                        ...
                        <td class="date-cell" style="padding:14px 16px;border-bottom:1px solid rgba(18,63,110,0.04);color:#64748b;font-weight:500">{{ $task->start_date->format('d/m/Y') }}</td>
                        <td class="date-cell" style="padding:14px 16px;border-bottom:1px solid rgba(18,63,110,0.04);color:{{ $task->isDelayed() ? '#ef4444' : '#64748b' }};font-weight:{{ $task->isDelayed() ? '600' : '400' }}">{{ $task->end_date->format('d/m/Y') }}</td>
                        <td class="delay-cell" style="padding:14px 16px;border-bottom:1px solid rgba(18,63,110,0.04)">
                        ...
                        <td class="progress-cell" style="padding:14px 16px;border-bottom:1px solid rgba(18,63,110,0.04)">
                        ...
                        <td class="status-cell" style="padding:14px 16px;border-bottom:1px solid rgba(18,63,110,0.04)">
                        ...
                        <td class="actions-cell" style="padding:14px 16px;border-bottom:1px solid rgba(18,63,110,0.04)">
                            <div style="display:flex;gap:6px">
                                ...
                                @endif
                                @if(auth()->user()->hasPermission('group_tasks.archive') && in_array($task->status, ['finalizada', 'completada', 'cancelada'], true))
