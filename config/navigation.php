...
return [
    'items' => [
        ...
        ['name' => 'Tareas', 'icon' => 'list-checks', 'route' => null, 'permission' => 'tasks.view', 'order' => 20, 'enabled' => true],
        ...
        ['name' => 'Usuarios', 'icon' => 'user-cog', 'route' => null, 'permission' => 'users.view', 'order' => 90, 'enabled' => true],
        ['name' => 'Roles y permisos', 'icon' => 'shield-check', 'route' => null, 'permission' => 'roles.view', 'order' => 100, 'enabled' => true],
        ['name' => 'Auditoria', 'icon' => 'scan-search', 'route' => null, 'permission' => 'audit.view', 'order' => 110, 'enabled' => true],
