...
class AuthEvent extends BaseModel
{
    ...
    public const EVENT_LABELS = [
        ...
        'bsc_perspective_created' => 'Perspectiva BSC creada',
        'bsc_perspective_updated' => 'Perspectiva BSC actualizada',
        'bsc_perspective_toggled' => 'Estado de perspectiva BSC cambiado',
        'bsc_perspective_moved' => 'Orden de perspectiva BSC modificado',
